...
void syserr_warn(const char *x1, const char *x2, const char *x3, const char *x4,
                 ...
                 struct syserr *se)
{
  ...
  if (x7) buffer_puts(buffer2, x7);
  if (x8) buffer_puts(buffer2, x8);
...
void syserr_die(int e, const char *x1, const char *x2, const char *x3, const char *x4,
                       const char *x5, const char *x6, const char *x7, const char *x8,
                       struct syserr *se)
{
