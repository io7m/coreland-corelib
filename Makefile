...
objects:\
	alloc.o array.o array_bytes.o array_cat.o array_copy.o \
	array_data.o array_index.o array_size.o bin_chr.o bin_copy.o \
	bin_copyr.o bin_count.o bin_diff.o bin_rchr.o bin_set.o \
	bin_tolower.o bin_toupper.o bin_zero.o buffer0.o buffer1.o \
	buffer2.o buffer_get.o buffer_init.o buffer_put.o \
	closeonexec.o dir_array.o dstring_0.o dstring_cat.o \
	dstring_cat0.o dstring_catb.o dstring_cats.o dstring_chop.o \
	dstring_copy.o dstring_cpyb.o dstring_cpys.o dstring_init.o \
	dstring_trunc.o error.o error_str.o fd_dup.o fd_move.o \
	fd_reset.o float32_pack.o float32_upack.o float64_pack.o \
	float64_upack.o fmt_byte.o fmt_byteo.o fmt_bytex.o fmt_u32.o \
	fmt_u32o.o fmt_u32x.o fmt_u64.o fmt_u64o.o fmt_u64x.o \
	get_opt.o ht_addb.o ht_adds.o ht_addu32.o ht_bytes.o \
	ht_deleteb.o ht_deletes.o ht_destroy.o ht_getb.o ht_gets.o \
	ht_getu32.o ht_hash.o ht_init.o ht_replaceb.o ht_replaces.o \
	int16_pack.o int16_unpack.o int32_pack.o int32_unpack.o \
	int64_pack.o int64_unpack.o nonblock.o open_append.o \
	open_creat.o open_excl.o open_ro.o open_rw.o open_trunc.o \
	open_wo.o scan_chars.o scan_double.o scan_f32.o scan_f64.o \
	scan_float.o scan_newline.o scan_space.o scan_u32.o \
	scan_u32o.o scan_u32x.o scan_u64.o scan_u64o.o scan_u64x.o \
