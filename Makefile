...
all: sysdeps.out alloc.a array.a base_name.a bin.a buffer.a \
	...
	dir_hash.a dir_name.a dstring.a env.a error.a fd.a float32.a \
	float64.a fmt.a fmt_spec.a get_opt.a hashtable.a iarray.a inst-check \
	inst-copy inst-dir inst-link installer instchk int16.a int32.a \
	int64.a nonblock.a open.a sarray.a scan.a scan_fspec.a scan_spec.a \
	seek.a sgetline.a sig.a squeue.a sstack.a sstring.a stalloc.a str.a \
	syserr.a uint.a uint16.a uint32.a uint64.a 
...
clean: sysdeps_clean tests_clean 
	...
	ht_addb.o 
	rm -f ht_adds.o ht_bytes.o ht_deleteb.o ht_deletes.o ht_free.o \
	ht_getb.o ht_gets.o ht_hash.o ht_init.o ht_replaceb.o ht_replaces.o \
	iarray.a iarray_bytes.o iarray_cat.o iarray_chop.o iarray_copy.o \
	...
	rm -f sarray_cat.o sarray_chop.o sarray_data.o sarray_index.o \
	...
	sstack_data.o 
	rm -f sstack_init.o sstack_peek.o sstack_pop.o sstack_push.o \
