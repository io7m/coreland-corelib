...
dqueue.a dstring.a env.a error.a fd.a fd_seek.a fmt.a get_opt.a hashtable.a \
iarray.a inst-check inst-copy inst-dir inst-link installer instchk \
nonblock.a open.a rmkdir.a sarray.a scan.a sgetline.a sig.a squeue.a \
...
dqueue_free.o dqueue_init.o dqueue_peek.o dqueue_size.o 
...
dqueue_enq.o:\
cc-compile dqueue_enq.c dqueue.h 
...
obj_clean: 
	...
	dir_name.a dir_name.o dqueue.a dqueue_bytes.o dqueue_data.o \
	dqueue_deq.o dqueue_enq.o dqueue_free.o dqueue_init.o dqueue_peek.o \
	dqueue_size.o dstring.a dstring_0.o dstring_cat.o dstring_catb.o \
	dstring_cats.o dstring_chop.o dstring_copy.o dstring_cpyb.o \
	dstring_cpys.o dstring_data.o dstring_init.o dstring_size.o \
	...
	fmt_llongo.o fmt_llongx.o fmt_long.o fmt_longb.o 
	...
	nonblock.a nonblock.o 
	rm -f open.a open_append.o open_creat.o open_excl.o open_ro.o \
	...
	rm -f squeue_enq.o squeue_init.o squeue_peek.o squeue_size.o \
	sstack.a sstack_bytes.o sstack_data.o sstack_init.o sstack_peek.o \
