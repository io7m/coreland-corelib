...
dir_walk.a dqueue.a dstack.a dstring.a env.a error.a fd.a fd_seek.a fmt.a \
get_opt.a hashtable.a iarray.a inst-check inst-copy inst-dir inst-link \
installer instchk nonblock.a open.a rmkdir.a sarray.a scan.a sgetline.a \
sig.a squeue.a sstack.a sstring.a stalloc.a str.a syserr.a sysinfo 
...
obj_clean: 
	...
	fmt_float.o fmt_int.o 
	rm -f fmt_intb.o fmt_into.o fmt_intx.o fmt_llong.o fmt_llongb.o \
	...
	fmt_shortx.o fmt_str.o get_opt.a get_opt.o hashtable.a ht_addb.o \
	ht_adds.o ht_bytes.o ht_checkb.o ht_checks.o ht_deleteb.o \
	...
	inst-dir.o inst-link inst-link.o install_core.o 
	rm -f install_error.o installer installer.o instchk instchk.o \
	insthier.o nonblock.a nonblock.o open.a open_append.o open_creat.o \
	open_excl.o open_ro.o open_rw.o open_trunc.o open_wo.o rmkdir.a \
	rmkdir.o sarray.a sarray_bytes.o sarray_cat.o sarray_chop.o \
	sarray_data.o sarray_index.o sarray_init.o sarray_size.o \
	sarray_trunc.o scan.a scan_char.o scan_charb.o scan_charo.o \
	scan_chars.o scan_charsn.o scan_charx.o scan_double.o scan_float.o \
	...
	rm -f sig.o sig_block.o sig_catch.o sig_pause.o squeue.a \
	squeue_bytes.o squeue_data.o squeue_deq.o squeue_enq.o squeue_init.o \
	squeue_peek.o squeue_size.o sstack.a sstack_bytes.o sstack_data.o \
	sstack_init.o sstack_peek.o sstack_pop.o sstack_push.o sstack_size.o \
