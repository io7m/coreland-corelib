...
clean: sysdeps_clean tests_clean 
	...
	ht_replaceb.o ht_replaces.o inst-check 
	rm -f inst-check.o inst-copy inst-copy.o inst-dir inst-dir.o \
	...
	int64_pack.o int64_unpack.o nonblock.a nonblock.o open.a \
	...
	scan_ullong.o scan_ullongo.o scan_ullongx.o scan_ulong.o \
	scan_ulongo.o scan_ulongx.o scan_ushort.o scan_ushorto.o 
	rm -f scan_ushortx.o seek.a seek_cur.o seek_end.o seek_pos.o \
	seek_start.o sgetline.a sgetline.o sgetline_chop.o sgetline_get.o \
	sig_block.o sig_catch.o sig_pause.o signal.a signal.o sstring.a \
