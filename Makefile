...
fmt_pad_ll.o:\
	cc-compile fmt_pad_ll.c sd_longlong.h fmt.h 
...
obj_clean: 
	...
	dgetline_init.o dgetline_lnum.o dgetline_size.o dir_array.a 
	rm -f dir_array.o dir_hash.a dir_hash.o dir_name.a dir_name.o \
