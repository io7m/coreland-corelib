...
obj_clean: 
	...
	fmt_pad_l.o fmt_pad_ll.o fmt_pad_s.o fmt_short.o 
	rm -f fmt_shortb.o fmt_shorto.o fmt_shortx.o fmt_str.o get_opt.a \
	...
	mk-ctxt nonblock.a nonblock.o open.a open_append.o open_creat.o \
	open_excl.o open_ro.o open_rw.o open_trunc.o open_wo.o rmkdir.a 
	rm -f rmkdir.o sarray.a sarray_bytes.o sarray_cat.o sarray_chop.o \
	sarray_data.o sarray_index.o sarray_init.o sarray_size.o \
	...
	sstack_peek.o 
	rm -f sstack_pop.o sstack_push.o sstack_size.o sstring.a \
