...
obj_clean: 
	...
	fd_seek_end.o fd_seek_pos.o fd_seek_start.o fmt.a fmt_double.o \
	fmt_float.o fmt_nstr.o fmt_str.o fmt_uchar.o fmt_ucharb.o \
	...
	fmt_ushorto.o fmt_ushortx.o get_opt.a get_opt.o 
	...
	sarray_init.o sarray_size.o 
	rm -f sarray_trunc.o scan.a scan_charset.o scan_double.o \
	scan_float.o scan_ncharset.o scan_newline.o scan_space.o \
	...
	sstring_cpys.o sstring_init.o stalloc.a 
	rm -f stalloc.o str.a str_char.o str_chr.o str_ci_diff.o \
	...
	syserr.a syserr_die.o syserr_init.o uint.a uint_pack.o uint_unpack.o \
