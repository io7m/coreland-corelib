...
all:\
alloc.a alloc.o array.a array.o array_bytes.o array_cat.o array_catb.o \
array_catn.o array_chop.o array_copy.o array_data.o array_index.o array_size.o \
array_trunc.o array_zero.o base_name.a base_name.o bin.a bin_char.o bin_chr.o \
bin_copy.o bin_copyr.o bin_count.o bin_diff.o bin_rchar.o bin_rchr.o bin_set.o \
bin_tolower.o bin_toupper.o bin_zero.o buffer.a buffer0.o buffer1.o buffer2.o \
buffer_copy.o buffer_get.o buffer_init.o buffer_put.o closeonexec.a \
closeonexec.o corelib-conf corelib-conf.o ctxt/bindir.o ctxt/ctxt.a \
...
dgetline_free.o dgetline_get.o dgetline_init.o dgetline_lnum.o dgetline_size.o \
dir_array.a dir_array.o dir_hash.a dir_hash.o dir_name.a dir_name.o dir_walk.a \
dir_walk.o dqueue.a dqueue_bytes.o dqueue_data.o dqueue_deq.o dqueue_enq.o \
dqueue_free.o dqueue_init.o dqueue_peek.o dqueue_size.o dqueue_zero.o dstack.a \
dstack_bytes.o dstack_data.o dstack_free.o dstack_init.o dstack_peek.o \
dstack_pop.o dstack_push.o dstack_size.o dstring.a dstring_0.o dstring_cat.o \
dstring_catb.o dstring_cats.o dstring_chop.o dstring_copy.o dstring_cpyb.o \
dstring_cpys.o dstring_data.o dstring_init.o dstring_size.o dstring_trunc.o \
env.a env.o env_get.o error.a error.o error_str.o fd.a fd_dup.o fd_move.o \
fd_reset.o fd_seek.a fd_seek_cur.o fd_seek_end.o fd_seek_pos.o fd_seek_start.o \
fmt.a fmt_char.o fmt_charb.o fmt_charo.o fmt_charx.o fmt_double.o fmt_float.o \
fmt_int.o fmt_intb.o fmt_into.o fmt_intx.o fmt_llong.o fmt_llongb.o \
fmt_llongo.o fmt_llongx.o fmt_long.o fmt_longb.o fmt_longo.o fmt_longx.o \
fmt_nstr.o fmt_pad_c.o fmt_pad_i.o fmt_pad_l.o fmt_pad_ll.o fmt_pad_s.o \
fmt_short.o fmt_shortb.o fmt_shorto.o fmt_shortx.o fmt_str.o get_opt.a \
get_opt.o hashtable.a ht_addb.o ht_adds.o ht_bytes.o ht_checkb.o ht_checks.o \
...
array.a:\
cc-slib array.sld array.o array_bytes.o array_cat.o array_catb.o array_catn.o \
array_chop.o array_copy.o array_data.o array_index.o array_size.o array_trunc.o \
array_zero.o
	./cc-slib array array.o array_bytes.o array_cat.o array_catb.o array_catn.o \
	array_chop.o array_copy.o array_data.o array_index.o array_size.o array_trunc.o \
	array_zero.o
...
array_cat.o:\
cc-compile array_cat.c array.h
	./cc-compile array_cat.c

array_catb.o:\
cc-compile array_catb.c alloc.h array.h bin.h
	./cc-compile array_catb.c

array_catn.o:\
cc-compile array_catn.c array.h
	./cc-compile array_catn.c
...
bin_zero.o
	./cc-slib bin bin_char.o bin_rchar.o bin_chr.o bin_copy.o bin_copyr.o \
	bin_count.o bin_diff.o bin_rchr.o bin_set.o bin_tolower.o bin_toupper.o \
	bin_zero.o
...
buffer_put.o buffer_copy.o
	./cc-slib buffer buffer0.o buffer1.o buffer2.o buffer_get.o buffer_init.o \
	buffer_put.o buffer_copy.o
...
dir_walk.a:\
cc-slib dir_walk.sld dir_walk.o
	./cc-slib dir_walk dir_walk.o

dir_walk.h:\
sstring.h

dir_walk.o:\
cc-compile dir_walk.c bin.h dir_array.h open.h str.h sstring.h dir_walk.h
...
dqueue_free.o dqueue_init.o dqueue_peek.o dqueue_size.o dqueue_zero.o
	./cc-slib dqueue dqueue_bytes.o dqueue_data.o dqueue_deq.o dqueue_enq.o \
	dqueue_free.o dqueue_init.o dqueue_peek.o dqueue_size.o dqueue_zero.o

dqueue_bytes.o:\
cc-compile dqueue_bytes.c dqueue.h
	./cc-compile dqueue_bytes.c

dqueue_data.o:\
cc-compile dqueue_data.c dqueue.h
	./cc-compile dqueue_data.c

dqueue_deq.o:\
cc-compile dqueue_deq.c dqueue.h
	./cc-compile dqueue_deq.c

dqueue_enq.o:\
cc-compile dqueue_enq.c alloc.h bin.h dqueue.h
	./cc-compile dqueue_enq.c

dqueue_free.o:\
cc-compile dqueue_free.c alloc.h dqueue.h
	./cc-compile dqueue_free.c

dqueue_init.o:\
cc-compile dqueue_init.c alloc.h dqueue.h
	./cc-compile dqueue_init.c

dqueue_peek.o:\
cc-compile dqueue_peek.c dqueue.h
	./cc-compile dqueue_peek.c

dqueue_size.o:\
cc-compile dqueue_size.c dqueue.h
	./cc-compile dqueue_size.c

dqueue_zero.o:\
cc-compile dqueue_zero.c dqueue.h
...
dstack_peek.o dstack_pop.o dstack_push.o dstack_size.o
	./cc-slib dstack dstack_bytes.o dstack_data.o dstack_free.o dstack_init.o \
	dstack_peek.o dstack_pop.o dstack_push.o dstack_size.o
...
cc-compile dstack_init.c dstack.h
	./cc-compile dstack_init.c

dstack_peek.o:\
cc-compile dstack_peek.c dstack.h
	./cc-compile dstack_peek.c

dstack_pop.o:\
cc-compile dstack_pop.c dstack.h
	./cc-compile dstack_pop.c

dstack_push.o:\
cc-compile dstack_push.c dstack.h
	./cc-compile dstack_push.c

dstack_size.o:\
cc-compile dstack_size.c dstack.h
	./cc-compile dstack_size.c
...
dstring_init.o dstring_size.o dstring_trunc.o
	./cc-slib dstring dstring_0.o dstring_cat.o dstring_catb.o dstring_cats.o \
	dstring_chop.o dstring_copy.o dstring_cpyb.o dstring_cpys.o dstring_data.o \
	dstring_init.o dstring_size.o dstring_trunc.o
...
fd_seek.a:\
cc-slib fd_seek.sld fd_seek_cur.o fd_seek_end.o fd_seek_pos.o fd_seek_start.o
	./cc-slib fd_seek fd_seek_cur.o fd_seek_end.o fd_seek_pos.o fd_seek_start.o
...
fmt_float.o fmt_int.o fmt_intb.o fmt_into.o fmt_intx.o fmt_llong.o fmt_llongb.o \
fmt_llongo.o fmt_llongx.o fmt_long.o fmt_longb.o fmt_longo.o fmt_longx.o \
fmt_nstr.o fmt_pad_c.o fmt_pad_i.o fmt_pad_l.o fmt_pad_ll.o fmt_pad_s.o \
fmt_short.o fmt_shortb.o fmt_shorto.o fmt_shortx.o fmt_str.o
	./cc-slib fmt fmt_char.o fmt_charb.o fmt_charo.o fmt_charx.o fmt_double.o \
	fmt_float.o fmt_int.o fmt_intb.o fmt_into.o fmt_intx.o fmt_llong.o fmt_llongb.o \
	fmt_llongo.o fmt_llongx.o fmt_long.o fmt_longb.o fmt_longo.o fmt_longx.o \
	fmt_nstr.o fmt_pad_c.o fmt_pad_i.o fmt_pad_l.o fmt_pad_ll.o fmt_pad_s.o \
	fmt_short.o fmt_shortb.o fmt_shorto.o fmt_shortx.o fmt_str.o
...
ht_iter.o ht_replaceb.o ht_replaces.o
	./cc-slib hashtable ht_addb.o ht_adds.o ht_bytes.o ht_checkb.o ht_checks.o \
	ht_deleteb.o ht_deletes.o ht_free.o ht_getb.o ht_gets.o ht_hash.o ht_init.o \
	ht_iter.o ht_replaceb.o ht_replaces.o
...
iarray_remove.o iarray_size.o iarray_sort.o iarray_trunc.o iarray_zero.o
	./cc-slib iarray iarray_bytes.o iarray_cat.o iarray_chop.o iarray_copy.o \
	iarray_free.o iarray_index.o iarray_init.o iarray_insert.o iarray_node.o \
	iarray_remove.o iarray_size.o iarray_sort.o iarray_trunc.o iarray_zero.o
...
open_trunc.o open_wo.o
	./cc-slib open open_append.o open_creat.o open_excl.o open_ro.o open_rw.o \
	open_trunc.o open_wo.o
...
sarray_index.o sarray_init.o sarray_size.o sarray_trunc.o
	./cc-slib sarray sarray_bytes.o sarray_cat.o sarray_chop.o sarray_data.o \
	sarray_index.o sarray_init.o sarray_size.o sarray_trunc.o
...
scan_into.o scan_intx.o scan_llong.o scan_llongb.o scan_llongo.o scan_llongx.o \
scan_long.o scan_longb.o scan_longo.o scan_longx.o scan_nchars.o scan_ncharsn.o \
scan_newline.o scan_short.o scan_shortb.o scan_shorto.o scan_shortx.o \
scan_space.o
	./cc-slib scan scan_char.o scan_charb.o scan_charo.o scan_chars.o scan_charsn.o \
	scan_charx.o scan_double.o scan_float.o scan_int.o scan_intb.o scan_into.o \
	scan_intx.o scan_llong.o scan_llongb.o scan_llongo.o scan_llongx.o scan_long.o \
...
sgetline.a:\
cc-slib sgetline.sld sgetline.o sgetline_chop.o sgetline_data.o sgetline_get.o \
sgetline_lnum.o sgetline_size.o
	./cc-slib sgetline sgetline.o sgetline_chop.o sgetline_data.o sgetline_get.o \
	sgetline_lnum.o sgetline_size.o
...
squeue_init.o squeue_peek.o squeue_size.o
	./cc-slib squeue squeue_bytes.o squeue_data.o squeue_deq.o squeue_enq.o \
	squeue_init.o squeue_peek.o squeue_size.o
...
sstack_pop.o sstack_push.o sstack_size.o
	./cc-slib sstack sstack_bytes.o sstack_data.o sstack_init.o sstack_peek.o \
	sstack_pop.o sstack_push.o sstack_size.o
...
sstring_copy.o sstring_cpyb.o sstring_cpys.o sstring_init.o sstring_chop.o
	./cc-slib sstring sstring_0.o sstring_cat.o sstring_catb.o sstring_cats.o \
	sstring_copy.o sstring_cpyb.o sstring_cpys.o sstring_init.o sstring_chop.o
...
str_dup.o str_ends.o str_len.o str_ndiff.o str_rchar.o str_rchr.o str_starts.o \
str_tolower.o str_toupper.o
	./cc-slib str str_char.o str_chr.o str_ci_diff.o str_ci_ndiff.o str_diff.o \
	str_dup.o str_ends.o str_len.o str_ndiff.o str_rchar.o str_rchr.o str_starts.o \
	str_tolower.o str_toupper.o
...
clean: obj_clean
obj_clean:
	rm -f alloc.a alloc.o array.a array.o array_bytes.o array_cat.o array_catb.o \
	array_catn.o array_chop.o array_copy.o array_data.o array_index.o array_size.o \
	array_trunc.o array_zero.o base_name.a base_name.o bin.a bin_char.o bin_chr.o \
	bin_copy.o bin_copyr.o bin_count.o bin_diff.o bin_rchar.o bin_rchr.o bin_set.o \
	bin_tolower.o bin_toupper.o bin_zero.o buffer.a buffer0.o buffer1.o buffer2.o \
	buffer_copy.o buffer_get.o buffer_init.o buffer_put.o closeonexec.a \
	closeonexec.o corelib-conf corelib-conf.o ctxt/bindir.c ctxt/bindir.o \
	...
	ctxt/version.o deinstaller deinstaller.o dgetline.a dgetline_chop.o \
	dgetline_data.o dgetline_free.o dgetline_get.o dgetline_init.o dgetline_lnum.o \
	dgetline_size.o dir_array.a dir_array.o dir_hash.a dir_hash.o dir_name.a \
	dir_name.o dir_walk.a dir_walk.o dqueue.a dqueue_bytes.o dqueue_data.o \
	dqueue_deq.o dqueue_enq.o dqueue_free.o dqueue_init.o dqueue_peek.o \
	dqueue_size.o dqueue_zero.o dstack.a dstack_bytes.o dstack_data.o dstack_free.o
	rm -f dstack_init.o dstack_peek.o dstack_pop.o dstack_push.o dstack_size.o \
	dstring.a dstring_0.o dstring_cat.o dstring_catb.o dstring_cats.o \
	dstring_chop.o dstring_copy.o dstring_cpyb.o dstring_cpys.o dstring_data.o \
	dstring_init.o dstring_size.o dstring_trunc.o env.a env.o env_get.o error.a \
	error.o error_str.o fd.a fd_dup.o fd_move.o fd_reset.o fd_seek.a fd_seek_cur.o \
	fd_seek_end.o fd_seek_pos.o fd_seek_start.o fmt.a fmt_char.o fmt_charb.o \
	fmt_charo.o fmt_charx.o fmt_double.o fmt_float.o fmt_int.o fmt_intb.o \
	fmt_into.o fmt_intx.o fmt_llong.o fmt_llongb.o fmt_llongo.o fmt_llongx.o \
	fmt_long.o fmt_longb.o fmt_longo.o fmt_longx.o fmt_nstr.o fmt_pad_c.o \
	fmt_pad_i.o fmt_pad_l.o fmt_pad_ll.o fmt_pad_s.o fmt_short.o fmt_shortb.o \
	fmt_shorto.o fmt_shortx.o fmt_str.o get_opt.a get_opt.o hashtable.a ht_addb.o \
	ht_adds.o ht_bytes.o ht_checkb.o ht_checks.o ht_deleteb.o ht_deletes.o \
	ht_free.o ht_getb.o ht_gets.o ht_hash.o ht_init.o ht_iter.o ht_replaceb.o \
