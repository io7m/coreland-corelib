...
obj_clean: 
	...
	conf-ldtype conf-systype corelib-conf corelib-conf.o ctxt/bindir.c \
	...
	dgetline_free.o dgetline_get.o dgetline_init.o 
	rm -f dgetline_lnum.o dgetline_size.o dir_array.a dir_array.o \
	...
	fmt_shorto.o 
	rm -f fmt_shortx.o fmt_str.o get_opt.a get_opt.o hashtable.a \
	...
	syserr_init.o sysinfo sysinfo.o uint.a uint_pack.o uint_unpack.o 
