...
struct install_item insthier[] = {
  ...
  {IOP_LIBLINK, "alloc.a", "liballoc.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "array.a", "libarray.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "base_name.a", "libbase_name.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "bin.a", "libbin.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "buffer.a", "libbuffer.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "closeonexec.a", "libcloseonexec.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "dir_array.a", "libdir_array.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "dir_hash.a", "libdir_hash.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "dir_name.a", "libdir_name.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "dstring.a", "libdstring.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "env.a", "libenv.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "error.a", "liberror.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "fd.a", "libfd.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "float32.a", "libfloat32.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "float64.a", "libfloat64.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "fmt.a", "libfmt.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "fmt_spec.a", "libfmt_spec.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "get_opt.a", "libget_opt.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "hashtable.a", "libhashtable.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "int16.a", "libint16.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "int32.a", "libint32.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "int64.a", "libint64.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "nonblock.a", "libnonblock.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "open.a", "libopen.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "scan.a", "libscan.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "scan_fspec.a", "libscan_fspec.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "scan_spec.a", "libscan_spec.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "seek.a", "libseek.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "sgetline.a", "libsgetline.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "signal.a", "libsignal.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "sstring.a", "libsstring.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "stalloc.a", "libstalloc.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "str.a", "libstr.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "syserr.a", "libsyserr.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "uint16.a", "libuint16.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "uint32.a", "libuint32.a", ctxt_slibdir, 0, 0, 0},
  {IOP_LIBLINK, "uint64.a", "libuint64.a", ctxt_slibdir, 0, 0, 0},
};
