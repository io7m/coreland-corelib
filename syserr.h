...
extern void syserr_warn(const char *, const char *, const char *, const char *,
                        const char *, const char *, const char *, const char *,
                        struct syserr *);

extern void syserr_die(int, const char *, const char *, const char *, const char *,
                            const char *, const char *, const char *, const char *,
                            struct syserr *);
...
#define syserr_warn8(x1,x2,x3,x4,x5,x6,x7,x8,se) \
syserr_warn((x1),(x2),(x3),(x4),(x5),(x6),(x7),(x8),(se))
#define syserr_warn7(x1,x2,x3,x4,x5,x6,x7,se) \
syserr_warn((x1),(x2),(x3),(x4),(x5),(x6),(x7),0,(se))
#define syserr_warn6(x1,x2,x3,x4,x5,x6,se) \
syserr_warn((x1),(x2),(x3),(x4),(x5),(x6),0,0,(se))
#define syserr_warn5(x1,x2,x3,x4,x5,se) \
syserr_warn((x1),(x2),(x3),(x4),(x5),0,0,0,(se))
#define syserr_warn4(x1,x2,x3,x4,se) \
syserr_warn((x1),(x2),(x3),(x4),0,0,0,0,(se))
#define syserr_warn3(x1,x2,x3,se) \
syserr_warn((x1),(x2),(x3),0,0,0,0,0,(se))
#define syserr_warn2(x1,x2,se) \
syserr_warn((x1),(x2),0,0,0,0,0,0,(se))
#define syserr_warn1(x1,se) \
syserr_warn((x1),0,0,0,0,0,0,0,(se))

#define syserr_warn8sys(x1,x2,x3,x4,x5,x6,x7,x8) \
syserr_warn((x1),(x2),(x3),(x4),(x5),(x6),(x7),(x8),&syserr_sys)
#define syserr_warn7sys(x1,x2,x3,x4,x5,x6,x7) \
syserr_warn((x1),(x2),(x3),(x4),(x5),(x6),(x7),0,&syserr_sys)
#define syserr_warn6sys(x1,x2,x3,x4,x5,x6) \
syserr_warn((x1),(x2),(x3),(x4),(x5),(x6),0,0,&syserr_sys)
#define syserr_warn5sys(x1,x2,x3,x4,x5) \
syserr_warn((x1),(x2),(x3),(x4),(x5),0,0,0,&syserr_sys)
#define syserr_warn4sys(x1,x2,x3,x4) \
syserr_warn((x1),(x2),(x3),(x4),0,0,0,0,&syserr_sys)
#define syserr_warn3sys(x1,x2,x3) \
syserr_warn((x1),(x2),(x3),0,0,0,0,0,&syserr_sys)
#define syserr_warn2sys(x1,x2) \
syserr_warn((x1),(x2),0,0,0,0,0,0,&syserr_sys)
#define syserr_warn1sys(x1) \
syserr_warn((x1),0,0,0,0,0,0,0,&syserr_sys)

#define syserr_warn8x(x1,x2,x3,x4,x5,x6,x7,x8) \
syserr_warn((x1),(x2),(x3),(x4),(x5),(x6),(x7),(x8),0)
#define syserr_warn7x(x1,x2,x3,x4,x5,x6,x7) \
syserr_warn((x1),(x2),(x3),(x4),(x5),(x6),(x7),0,0)
#define syserr_warn6x(x1,x2,x3,x4,x5,x6) \
syserr_warn((x1),(x2),(x3),(x4),(x5),(x6),0,0,0)
#define syserr_warn5x(x1,x2,x3,x4,x5) \
syserr_warn((x1),(x2),(x3),(x4),(x5),0,0,0,0)
#define syserr_warn4x(x1,x2,x3,x4) \
syserr_warn((x1),(x2),(x3),(x4),0,0,0,0,0)
#define syserr_warn3x(x1,x2,x3) \
syserr_warn((x1),(x2),(x3),0,0,0,0,0,0)
#define syserr_warn2x(x1,x2) \
syserr_warn((x1),(x2),0,0,0,0,0,0,0)
#define syserr_warn1x(x1) \
syserr_warn((x1),0,0,0,0,0,0,0,0)

#define syserr_die8(e,x1,x2,x3,x4,x5,x6,x7,x8,se) \
syserr_die((e),(x1),(x2),(x3),(x4),(x5),(x6),(x7),(x8),(se))
#define syserr_die7(e,x1,x2,x3,x4,x5,x6,x7,se) \
syserr_die((e),(x1),(x2),(x3),(x4),(x5),(x6),(x7),0,(se))
#define syserr_die6(e,x1,x2,x3,x4,x5,x6,se) \
syserr_die((e),(x1),(x2),(x3),(x4),(x5),(x6),0,0,(se))
#define syserr_die5(e,x1,x2,x3,x4,x5,se) \
syserr_die((e),(x1),(x2),(x3),(x4),(x5),0,0,0,(se))
#define syserr_die4(e,x1,x2,x3,x4,se) \
syserr_die((e),(x1),(x2),(x3),(x4),0,0,0,0,(se))
#define syserr_die3(e,x1,x2,x3,se) \
syserr_die((e),(x1),(x2),(x3),0,0,0,0,0,(se))
#define syserr_die2(e,x1,x2,se) \
syserr_die((e),(x1),(x2),0,0,0,0,0,0,(se))
