    ...
    switch (int_list[i].sz) {
      ...
      case 32:
        ...
        switch (int_list[i].base) {
          case 10:
            scan_u32(int_list[i].str, &u32);
            if (u32 != (uint32) int_list[i].n) {
              printf("scan_u32: [%u] u32 == %lu\n", i, u32); return 1;
            }
            break;
          case 16:
            scan_u32x(int_list[i].str, &u32);
            if (u32 != (uint32) int_list[i].n) {
              printf("scan_u32x: [%u] u32 == %lx\n", i, u32); return 1;
            }
            break;
          case 8:
            scan_u32o(int_list[i].str, &u32);
            if (u32 != (uint32) int_list[i].n) {
              printf("scan_u32o: [%u] u32 == %lo\n", i, u32); return 1;
            }
            break;
          default: break;
        }
