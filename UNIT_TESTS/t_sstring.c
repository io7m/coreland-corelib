...
int main()
{
  ...
  if (str.a != BSIZE) { printf("fail: str.a == %u\n", str.a); return 1; }
  if (str.len != 0) { printf("fail: str.len == %u\n", str.len); return 1; }

  sstring_cats(&str, "ABCDEFGH");
  sstring_0(&str);
  if (str.len != 8) { printf("fail: 1 cats: len == %u\n", str.len); return 1; }

  /* should truncate */
  sstring_cats(&str, "12345678ABCDEFGH12345678ABCDEFGH");
  sstring_0(&str);
  if (str.len != (BSIZE - 1)) {
    printf("fail: 2 cats: len == %u\n", str.len); return 1;
  }
  if (str.s[BSIZE - 1] != 0) {
  ...
  sstring_trunc(&str);
  if (str.a != BSIZE) { printf("fail: 3 trunc: a == %u\n", str.a); return 1; }
  if (str.len != 0) { printf("fail: 3 trunc: len == %u\n", str.len); return 1; }

  /* should truncate */
  sstring_cpys(&str, "ABCDEFGH12345678ABCDEFGH12345678ABCDEFGH");
  sstring_0(&str);
  if (str.len != (BSIZE - 1)) {
    printf("fail: 3 cpys: len == %u\n", str.len); return 1;
  }
  if (str.s[BSIZE - 1] != 0) {
