...
int main()
{
  ...
  if (da.a[3][0] != '2') { printf("[%u] == %s\n", 3, da.a[3]); return 1; }
  if (da.a[4][0] != '3') { printf("[%u] == %s\n", 4, da.a[4]); return 1; }
  if (da.a[5][0] != '4') { printf("[%u] == %s\n", 5, da.a[5]); return 1; }
  if (da.a[6][0] != '5') { printf("[%u] == %s\n", 6, da.a[6]); return 1; }
  if (da.a[7][0] != '6') { printf("[%u] == %s\n", 7, da.a[7]); return 1; }
  if (da.a[8][0] != '7') { printf("[%u] == %s\n", 8, da.a[8]); return 1; }
  if (da.a[9][0] != '8') { printf("[%u] == %s\n", 9, da.a[9]); return 1; }
  if (da.a[10][0] != '9') { printf("[%u] == %s\n", 10, da.a[10]); return 1; }
  if (da.a[11][0] != '1') { printf("[%u] == %s\n", 11, da.a[11]); return 1; }
